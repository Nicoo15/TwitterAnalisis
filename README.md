...
---
title: "Old"
author: "Nicolás Montejano"
date: "2024-03-18"
output: html_document
---

**Nicolás Montejano Pisonero - 3º INSO B**
**Análisis de Sentimiento sobre "old" en Twitter**
...
ggplot(data = tweets_sentiment, aes(x = sentiment)) +
  ...
  ylab("Cantidad de Tweets") +
  ggtitle("Gráfico de Barras")
En ambos grupos, RightTroll y LeftTroll, los tweets parecen tener un rango de sentimientos más neutrales, con algunos extremos positivos y negativos, pero predominando valores cercanos a cero. Esto sugiere que los trolls de ambos lados pueden estar utilizando un lenguaje menos emocional en sus tweets relacionados con la palabra "old".
