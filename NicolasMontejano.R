...
#Lo primero que tenemos que hacer es quitar las palabras que sean simialer a old pero que no tengan nada que ver
...
#Ahora vamos a coger la muestra que solo hable de los temas relacionados con el "old"
...
#kwic busca todos los mensajes relacionados con el token old
