...
ggplot(data = tweets_sentiment, aes(x = sentiment)) +
  ...
  ylab("Cantidad de Tweets") +
  ggtitle("Gráfico de Barras")
En ambos grupos, RightTroll y LeftTroll, los tweets parecen tener un rango de sentimientos más neutrales, con algunos extremos positivos y negativos, pero predominando valores cercanos a cero. Esto sugiere que los trolls de ambos lados pueden estar utilizando un lenguaje menos